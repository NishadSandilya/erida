...
const validationSchema = yup.object().shape({
    ...
    paymentCompleted: yup.boolean('Must be either true of false').required('Required'),
    paymentMode: yup.string().oneOf(["Cash", "Razorpay", "UPI Apps"]),
    orderStatus: yup.string().oneOf(["Processing", 'Completed'])
})

const AdminEditOrder = ({ closeModal, id }) => {
    ...
    const serverREQ = async () => {
        try {
            ...
            const serverResponse = await axios({
                ...
                url: 'http://localhost:8000/v1/admin/search-order-by-ID',
                data: {
                    orderId: id
                }
            })
            setFields(() => serverResponse?.data?.payload?.items)
            setDataHere(previous => {
                ...
                return{
                    ...
                    address: serverResponse?.data?.payload?.address,
                    orderType: serverResponse?.data?.payload?.orderType,
                    paymentCompleted: serverResponse?.data?.payload?.paymentCompleted,
                    paymentMode: serverResponse?.data?.payload?.paymentMode,
                    orderStatus: serverResponse?.data?.payload?.orderStatus
                }
            })
            hocDisplayControls[1](() => {
                return {
    ...
    const onFormSubmit = async data => {
        ...
        try {
            ...
            const serverResponse = await axios({
                method: "post",
                withCredentials: true,
                url: "http://localhost:8000/v1/admin/update-order",
                data,
            })
            hocDisplayControls[1](() => {
                return {
        ...
        <div className="co-modal">
            ...
            <div className="co-modal__wrapper">
                ...
                >
                    ...
                    <Controller
                        name="orderType"
                        defaultValue={dataHere?.orderType}
                        control={control}
                    ...
                    <Controller
                        name="firstname"
                        defaultValue={dataHere?.firstname}
                        control={control}
                        render={({ field: { onChange, value }, fieldState: { error } }) => (
                            <TextField
                                variant="outlined"
                    ...
                    <Controller
                        name="lastname"
                        defaultValue={dataHere?.lastname}
                        control={control}
                        render={({ field: { onChange, value }, fieldState: { error } }) => (
                            <TextField
                                variant="outlined"
                    ...
                    <Controller
                        ...
                        defaultValue={dataHere?.paymentCompleted}
                        control={control}
                        render={({ field: { onChange, value }, fieldState: { error } }) => (
                            <TextField
                                variant="outlined"
                    ...
                    <Controller
                        name="paymentMode"
                        defaultValue={dataHere?.paymentMode}
                        control={control}
                        render={({ field: { onChange, value }, fieldState: { error } }) => (
                            <TextField
                                variant="outlined"
                    ...
                    <Controller
                        name="orderStatus"
                        defaultValue={dataHere?.orderStatus}
                        control={control}
                        render={({ field: { onChange, value }, fieldState: { error } }) => (
                            <TextField
                                variant="outlined"
